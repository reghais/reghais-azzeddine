...
const translations = {
  en: {
    ...
    "hero-citations-label": "Total Citations",
    "hero-hindex-label": "h-index",
    ...
    "request-wa": "Request via WhatsApp",
    ...
    "teaching-desc": "Academic lecturing and student guidance contributions at higher education institutions.",
    "teaching-univ-batna": "University of Batna 2",
    "teaching-batna-l1": "Lectures & Practical Works (Semesters: 2020-2021)",
    "teaching-batna-l2": "Lectures & Practical Works (Semesters: 2022-2023)",
    "teaching-batna-l3": "Lectures, Tutorials & Practicals (Semesters: 2024-2025)",
    "teaching-univ-biskra": "University of Biskra",
    "teaching-biskra-l1": "Lectures & Directed Tutorials (Semester 1: 2025)",
    "teaching-biskra-desc": "Focusing on Environmental Geology, Hydrogeology, and advanced Geochemical assessment.",
    "awards-title": "Reviewer Impact & Professional Certifications",
    "awards-desc": "International peer-review credentials, academic certifications, and advanced specialized training.",
    "awards-tab-edu": "Awards & Education",
    "awards-tab-certs": "Professional Certifications",
    "awards-tab-review": "Peer Review & Evaluation",
    "sub-cert-title": "Specialized Credentials & Certifications",
    "sub-cert-desc": "Official certifications in GIS, Remote Sensing, Data Manipulation in R, and Academic Research Writing.",
    "sub-reviewer-title": "Peer Reviewer Impact",
    "sub-reviewer-desc": "Verified review certificates for top international WoS/Scopus indexed scientific journals with Impact Factors.",
    ...
    "blog-download-pdf": "Download Article PDF",
    "blog-pdf-locked": "Protected PDF Document (Chihab2020)",
  ...
  ar: {
    ...
    "hero-citations-label": "إجمالي الاستشهادات",
    "hero-hindex-label": "مؤشر h-index",
    ...
    "request-wa": "اطلب النسخة عبر واتساب",
    ...
    "teaching-title": "الخبرة التدريسية والتعليمية",
    "teaching-desc": "المساهمات الأكاديمية في التدريس الجامعي وإلقاء المحاضرات وتأطير الطلاب بمؤسسات التعليم العالي.",
    "teaching-univ-batna": "جامعة باتنة 2",
    "teaching-batna-l1": "تقديم الدروس والأعمال التطبيقية (خلال السداسيات للفترة: 2020 - 2021)",
    "teaching-batna-l2": "تقديم الدروس والأعمال التطبيقية (خلال السداسيات للفترة: 2022 - 2023)",
    "teaching-batna-l3": "إلقاء المحاضرات والدروس والأعمال التطبيقية والموجهة (السداسي الأول للفترة: 2024 - 2025)",
    "teaching-univ-biskra": "جامعة بسكرة",
    "teaching-biskra-l1": "تقديم الدروس والأعمال الموجهة (السداسي الأول للفترة: 2025)",
    "teaching-biskra-desc": "التركيز على تدريس الجيولوجيا البيئية، الهيدروجيولوجيا، والتقييم الجيوكيميائي المتقدم للموارد المائية.",
    "awards-title": "أثر التحكيم والشهادات المهنية المتخصصة",
    "awards-desc": "الاعتمادات الدولية للتحكيم العلمي، والشهادات الأكاديمية، والتدريب المتقدم المتخصص.",
    "awards-tab-edu": "الجوائز والتعليم",
    "awards-tab-certs": "الشهادات المهنية",
    "awards-tab-review": "التحكيم والتقييم العلمي",
    "sub-cert-title": "الشهادات والاعتمادات المتخصصة",
    "sub-cert-desc": "شهادات رسمية في نظم المعلومات الجغرافية، الاستشعار عن بعد، معالجة البيانات بلغة R، وكتابة البحوث الأكاديمية.",
    "sub-reviewer-title": "أثر التحكيم العلمي",
    "sub-reviewer-desc": "شهادات مراجعة معتمدة لكبرى المجلات العلمية الدولية المصنفة ضمن WoS و Scopus ذات معامل التأثير العالي.",
    ...
    "blog-download-pdf": "تحميل المقال (PDF)",
    "blog-pdf-locked": "مستند PDF محمي (Chihab2020)",
